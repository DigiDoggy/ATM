...
public class ATM {
    ...
    /**
     * Process a fund depositt to an account
    ...
    /**
     * Process trancsferring funds from one account to another
     * @param theUser   the logged-in User object
     * @param sc        the scanner object used for user input
     */
     ...
     *
     * @param theUser the logged-in User object
     * @param sc      the Scanner object used user input
     */
     ...
     * @param sc      the Scanner object to use fir user input
